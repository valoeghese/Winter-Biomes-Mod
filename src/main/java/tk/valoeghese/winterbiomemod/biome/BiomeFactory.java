...
public class BiomeFactory
{
	...
	public ExtendedBiome.FlexibleSurfaceConfig surfaceConfig = new ExtendedBiome.FlexibleSurfaceConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.GRAVEL.getDefaultState());
	...
	public static class BiomePopulator
	{
		...
		public void buildTreeFeatures()
		{
			...
			for (Pair<Feature<DefaultFeatureConfig>, Float> feature : treeFeatures)
			{
				...
				this.parent.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, feature.getLeft().configure(FeatureConfig.DEFAULT).createDecoratedFeature(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraChanceDecoratorConfig(n1, this.extraTreeChance, this.extraTreeCount))));
			}
		}
	}
}